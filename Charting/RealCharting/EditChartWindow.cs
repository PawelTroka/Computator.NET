...
namespace Computator.NET.Charting.RealCharting
{
    partial class EditChartWindow : Form
    {
        ...
        {
            DialogResult result = titleFontDialog.ShowDialog();
        ...
        {
            DialogResult result = axisLabelsFontDialog.ShowDialog();
            // See if OK was pressed.
            if (result == DialogResult.OK)
        ...
        {
            DialogResult result = legendFontDialog.ShowDialog();
            // See if OK was pressed.
            if (result == DialogResult.OK)
        ...
        {
            DialogResult result = valuesFontDialog.ShowDialog();
            // See if OK was pressed.
            if (result == DialogResult.OK)
