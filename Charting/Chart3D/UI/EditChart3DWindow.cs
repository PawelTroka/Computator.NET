...
namespace Computator.NET.Charting.Chart3D
{
    public partial class EditChartWindow : Form
    {
        ...
        private void saveData()
        {
            ...
            if (fontChanged)
            {
                FontStyle fs = convertFontStyleToWindowsFontStyle(font.Style);
        ...
        {
            DialogResult result = labelsColorDialog.ShowDialog();
            if (result == DialogResult.OK)
            {
        ...
        {
            DialogResult result = axesColorDialog.ShowDialog();
            if (result == DialogResult.OK)
            {
        ...
        {
            DialogResult result = labelsFontDialog.ShowDialog();
            if (result == DialogResult.OK)
            {
