...
namespace Computator.NET.NumericalCalculations.MathematicalAnalysis
{
    internal class Integral
    {
        ...
        public static double monteCarloMethod(Func<double, double> fx, double a, double b, double N = N_MAX)
        {
            ...
            return MonteCarloIntegration.Integrate(fx, a, b, (int) N*10, 1/(10*N));
        }
        ...
        public static double nonAdaptiveGaussKronrodMethod(Func<double, double> fx, double a, double b, double N = N_MAX)
        {
        ...
        public static double simpsonNumericalIntegration(List<Complex> _x, int n)
        {
            int n2 = (n - 1)/2;
            int j1, j2;
            double sum = 0;
