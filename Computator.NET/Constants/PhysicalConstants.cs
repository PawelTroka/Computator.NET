...
namespace Computator.NET.Constants
{
    internal static class PhysicalConstants
    {
        ...
        public static readonly double MagneticConstant = 4*Math.PI*1e-7;
...
";
        ...
        {
            var sr = new StreamReader("allascii.txt");
            string line = "";
