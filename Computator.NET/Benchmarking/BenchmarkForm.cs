...
namespace Computator.NET.Benchmarking
{
    public partial class BenchmarkForm : Form
    {
        ...
        private void FunctionsTestBackgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            if (e.Cancelled)
            {
                MessageBox.Show(Strings.MathFunctionsCalculationSpeedTestCancelledByUser, Strings.Canceled);
            }
            ...
            {
                MessageBox.Show(Strings.MathFunctionsCalculationSpeedTestDoneSuccesfullyCheckOutYourPointsResults,
                    Strings.Done);
                functionsTestRichTextBox.Text = DateTime.Now.ToShortDateString() + " " +
                                                DateTime.Now.ToShortTimeString() + Strings.Result + benchmark.Points +
                                                Strings.Points + functionsTestRichTextBox.Text;
            }
        }

        private void FunctionsTestBackgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            progressBar2.Value = e.ProgressPercentage;
        }

        private void memoryTestBackgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            if (e.Cancelled)
            {
                MessageBox.Show(Strings.memoryTestBackgroundWorker_RunWorkerCompleted, Strings.Canceled);
            }
            ...
            {
                MessageBox.Show(Strings.MemoryAllocationSpeedTestDoneSuccesfullyCheckOutYourPointsResult, Strings.Done);
                memoryTestRichTextBox.Text = DateTime.Now.ToShortDateString() + " " + DateTime.Now.ToShortTimeString() +
                                             Strings.Result + benchmark.Points + Strings.Points +
                                             memoryTestRichTextBox.Text;
            }
        }

        private void memoryTestBackgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
