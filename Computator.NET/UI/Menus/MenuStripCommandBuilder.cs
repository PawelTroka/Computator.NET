...
{
    internal static class MenuStripCommandBuilder
    {
        public static List<IToolbarCommand> BuildMenuStripCommands(IMainForm view)
        {
            return new List<IToolbarCommand>
            {
                ...
                BuildFunctionsCommands(view.ExpressionView.ExpressionTextBox, view.ScriptingView.CodeEditorView,
                    view.CustomFunctionsView.CustomFunctionsEditor),
                BuildConstantsCommand(view.ExpressionView.ExpressionTextBox, view.ScriptingView.CodeEditorView,
                    view.CustomFunctionsView.CustomFunctionsEditor),
        ...
        {
            return new DummyCommand(MenuStrings.helpToolStripMenuItem1_Text)
            {
                ChildrenCommands = new List<IToolbarCommand>
                {
                    new FeaturesCommand(),
        ...
        {
            return new DummyCommand(MenuStrings.toolsToolStripMenuItem_Text)
            {
                ChildrenCommands = new List<IToolbarCommand>
                {
                    new OptionsCommand(),
        ...
        private static DummyCommand BuildConstantsCommand(ITextProvider expressionTextProvider,
            ITextProvider scriptingTextProvider, ITextProvider customFunctionsTextProvider)
        {
            return new DummyCommand(MenuStrings.constantsToolStripMenuItem_Text)
            {
                ChildrenCommands = new List<IToolbarCommand>
                {
                    new DummyCommand(MenuStrings.mathematicalConstantsToolStripMenuItem_Text)
                    {
                        ChildrenCommands =
                            BuildFunctionsOrConstantsCommands("MathematicalConstants", expressionTextProvider,
                                scriptingTextProvider, customFunctionsTextProvider)
                    },
                    new DummyCommand(MenuStrings.physicalConstantsToolStripMenuItem_Text)
                    {
                        ChildrenCommands =
                            BuildFunctionsOrConstantsCommands("PhysicalConstants", expressionTextProvider,
                                scriptingTextProvider, customFunctionsTextProvider)
                    }
                }
            };
        ...
        private static DummyCommand BuildFunctionsCommands(ITextProvider expressionTextProvider,
            ITextProvider scriptingTextProvider, ITextProvider customFunctionsTextProvider)
        {
            return new DummyCommand(MenuStrings.functionsToolStripMenuItem_Text)
            {
                ChildrenCommands = new List<IToolbarCommand>
                {
                    new DummyCommand(MenuStrings.elementaryFunctionsToolStripMenuItem_Text)
                    {
                        ChildrenCommands =
                            BuildFunctionsOrConstantsCommands("ElementaryFunctions", expressionTextProvider,
                                scriptingTextProvider, customFunctionsTextProvider)
                    },
                    new DummyCommand(MenuStrings.specialFunctionsToolStripMenuItem_Text)
                    {
                        ChildrenCommands =
                            BuildFunctionsOrConstantsCommands("SpecialFunctions", expressionTextProvider,
                                scriptingTextProvider, customFunctionsTextProvider)
                    }
                }
            };
        ...
        {
            return new DummyCommand(MenuStrings.editToolStripMenuItem1_Text)
            {
                ChildrenCommands = new List<IToolbarCommand>
                {
                    new UndoCommand(view.ScriptingView.CodeEditorView, view.CustomFunctionsView.CustomFunctionsEditor,
                        view),
                    new RedoCommand(view.ScriptingView.CodeEditorView, view.CustomFunctionsView.CustomFunctionsEditor,
                        view),
                    null,
                    new CutCommand(view.ScriptingView.CodeEditorView, view.CustomFunctionsView.CustomFunctionsEditor,
                        view),
                    new CopyCommand(view.ScriptingView.CodeEditorView, view.CustomFunctionsView.CustomFunctionsEditor,
                        view),
                    new PasteCommand(view.ScriptingView.CodeEditorView, view.CustomFunctionsView.CustomFunctionsEditor,
                        view),
                    null,
                    new SelectAllCommand(view.ScriptingView.CodeEditorView,
