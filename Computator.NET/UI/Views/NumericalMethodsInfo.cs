    ...
    public class NumericalMethodsInfo
    {
            ...
            _methods = new ReadOnlyDictionary<string, ReadOnlyDictionary<string, Delegate>>(
                new Dictionary<string, ReadOnlyDictionary<string, Delegate>>
                {
                    ...
                    {Strings.Function_root, new ReadOnlyDictionary<string, Delegate>(
                        new Dictionary<string, Delegate>
                        {
                            {Strings.bisection_method, (Func<Func<double,double>,double,double, double, uint,double>)FunctionRoot.bisectionMethod },
                            {Strings.secant_method, (Func<Func<double,double>,double,double, double, uint,double>)FunctionRoot.secantMethod },
                            {Strings.Brent_s_method, (Func<Func<double,double>,double,double, double, uint,double>)FunctionRoot.BrentMethod },
                            {Strings.Broyden_s_method, (Func<Func<double,double>,double,double, double, uint,double>)FunctionRoot.BroydenMethod },
                            {Strings.secant_Newton_Raphson_method, (Func<Func<double,double>,double,double, double, uint,double>)FunctionRoot.secantNewtonRaphsonMethod }
                        }) }
                });
        }

        public ReadOnlyDictionary<string, Func<Func<double, double>, double, double, double, uint, double>> FunctionRootMethods
        {
            get
            {
                ...
                return new ReadOnlyDictionary<string, Func<Func<double, double>, double, double, double, uint, double>>(newDict);
            }
        }
        ...
        public ReadOnlyDictionary<string, Func<Func<double, double>, double, double, double, double>> IntegrationMethods
        {
            get
            {
                ...
                return new ReadOnlyDictionary<string, Func<Func<double, double>, double, double, double, double>>(newDict);
            }
        }
